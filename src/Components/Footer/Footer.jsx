...
const Footer = () => {
  ...
  useEffect(() => {
    if (logoError) {
      ...
      const imgUrl = logoData.data[0].attributes.img_url;
      setLogo(imgUrl);
    }
  }, [logoData]);

  if (logoLoading) return <p>Loading...</p>;
  if (logoError) return <p>Error loading footer data</p>;

  return (
    <>
      <div className=" bg-slate-50">
        <footer className="container mx-auto pt-4 ">
          <div className="container-fluid px-4 md:px-28">
      ...
      <div className=" bg-gray-800 text-white  ">
        <div className=" container mx-auto  md:text-leftp-6  px-28 py-5  ">
