...
import Pranjalsir from '../assets/Pranjal Dubey-project.jpg';
import Arindom from '../assets/Arindam Ray-project.jpg';
import Ajits from '../assets/Ajit Sharma-project.jpg';
import Shashank from '../assets/Shashank Bannerjea-project.jpg';

const OurTeam = () => {
  return (
    <div className="bg-white my-16 flex items-center justify-center">
      <div className="container py-8 text-center">
        <span className="text-sm text-black border rounded-2xl shadow py-2 px-5">OUR TEAM</span>
        <h1 className="text-3xl md:text-5xl font-bold text-center my-7 text-cyan-500">Meet Our Experts</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
          <div className="bg-white p-4 rounded-lg transition-shadow duration-300 items-center md:2/4 sm:1/3 lg:w-6/8" >
            <img src={Pranjalsir} alt="Pranjal Dubey" className="   md:w-2/4   mx-auto rounded-md transform hover:scale-105 transition-transform duration-300" />
