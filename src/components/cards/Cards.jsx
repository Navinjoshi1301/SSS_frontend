...
const Cards = () => {
  return (
   <>
    <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6 p-4 mb-20 px-32 mt-10">
        <div className="w-full md:w-1/2 lg:w-1/2 bg-white rounded-lg shadow-md overflow-hidden" >
          <div className="flex">
